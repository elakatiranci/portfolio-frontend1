    ...
    <nav className={`bg-white border-gray-200 dark:bg-gray-900 rounded-lg shadow px-6 m-4 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6">
        <a href="#" className="flex items-center space-x-2 rtl:space-x-reverse">
          ...
          <span className="font-bold self-center text-3xl whitespace-nowrap dark:text-white">Portfolio</span>
        </a>
        <div className="flex items-center md:order-2 space-x-5 md:space-x-4 rtl:space-x-reverse">
          ...
          <button onClick={toggleDarkMode} aria-label="Toggle Dark Mode">
            {isDarkMode ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-moon">
          ...
          {isDropdownOpen && (
            <div ref={dropdownRef} className="top-16 right-12 absolute z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600">
              ...
              <ul className="py-2" aria-labelledby="user-menu-button">
                ...
                <li>
                  <a href="/profile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Profil</a>
                </li>
                <li>
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          ...
          <li>
              <a href="/" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:scale-105">About Me</a>
            </li>
            <li>
              <a href="/blog" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:scale-105">Blog</a>
            </li>
            <li>
              <a href="/proje" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 hover:scale-105">Proje</a>
            </li>
          </ul>
        </div>
      </div>
